...
class ChooseHiitMethod extends StatelessWidget {
  const ChooseHiitMethod({super.key});
      ...
      children: [
        ...
        GestureDetector(
            onTap: () {
              context
                  ...
                  .setHiitMethod(AppString.group);
            },
            child: const CardioButtonWidget(AppString.group)),
        const SizedBox(
        ...
        GestureDetector(
            onTap: () {
              context
                  .read<ScheduleScreenMainCubit>()
                  .setHiitMethod(AppString.sequentially);
            },
            child: const CardioButtonWidget(AppString.sequentially))
      ],
    );
  }
}
